...
class Rdataset(set.Set):
    ...
    def to_wire(self, name: Optional[name.Name], file: BytesIO, compress: Optional[Dict[name.Name, int]] = None,
...
def from_text_list(rdclass: Union[int, str], rdtype: Union[int, str], ttl: int, text_rdatas: str,
                   idna_codec: Optional[name.IDNACodec] = None) -> rdataset.Rdataset:
    ...
