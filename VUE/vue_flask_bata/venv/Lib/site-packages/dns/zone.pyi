...
class Zone:
    ...
    def iterate_rdatas(self, rdtype: Union[int, str] = rdatatype.ANY, covers: Union[int, str] = None) -> Iterable[
        Tuple[name.Name, int, rdata.Rdata]]:
        ...
    ...
    def get_rdataset(self, name: Union[str, name.Name], rdtype: Union[str, int], covers=rdatatype.NONE, create=False) -> \
    Optional[rdataset.Rdataset]:
        ...

    def get_rrset(self, name: Union[str, name.Name], rdtype: Union[str, int], covers=rdatatype.NONE) -> Optional[
        rrset.RRset]:
        ...
...
def from_xfr(xfr: Generator[Any, Any, message.Message], zone_factory: Callable[..., zone.Zone] = zone.Zone,
