  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="预定保险生效时间" prop="setoffTime">
          <el-date-picker
            v-model="form.setoffTime"
            type="date"
            placeholder="输入保险生效日期"
...
export default {
  ...
  created() {
    ...
    //this.id = parseInt(this.$route.query.insuranceId);
  },
  methods: {
    back() {
      this.$router.back();
            ...
            .then((res) => {
              ...
              if (res.code == 200) {
                ...
                this.$router.push({
                  ...
                  query: {
                    insuranceId: parseInt(this.$route.query.insuranceId),
                  },
                });
              } else {
                this.$message({
                  type: "info",
                  message: "投保失败！请留言联系客服",
                });
              }
            });
        } else {
